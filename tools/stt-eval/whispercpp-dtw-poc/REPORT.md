...
| CTranslate2 baseline model | `Systran/faster-whisper-small` (`model.bin`, sha256 `3E305921506D8872816023E4C273E75D2419FB89B24DA97B4FE7BCE14170D671`, ~461 MB) cached at `%APPDATA%\openrec\stt-models\whisper-ct2\`; built and shipped by OpenRec as `electron\native\bin\win32-x64\ctranslate2-server-ctranslate2-cpu.exe` |
...
# 3. Run CT2 baseline (uses OpenRec's pre-built server, does not rebuild)
node harness/run_ct2.mjs results int8  20199 "$env:APPDATA/openrec/stt-models/whisper-ct2" fixtures/jfk.wav fixtures/librispeech_demo_{0..4}.wav fixtures/two-min-clip.wav
node harness/run_ct2.mjs results fp16  20198 "$env:APPDATA/openrec/stt-models/whisper-ct2" fixtures/jfk.wav fixtures/librispeech_demo_{0..4}.wav fixtures/two-min-clip.wav
