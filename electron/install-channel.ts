// How this copy of OpenRec was installed, and therefore WHO is allowed to update it.
//
...
// ponytail: a distro that REPACKAGES our .pacman (the AUR `openrec` package does exactly
