...
import { createOpenRecChatModel, messageContentToText } from "./deep-agent/chat-model";
...
export async function translateCaptionSegments(
	...
	let model: Awaited<ReturnType<typeof createOpenRecChatModel>>;
	try {
		model = await createOpenRecChatModel({
