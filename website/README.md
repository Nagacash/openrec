...
cd website
npm install
npm run dev      # http://localhost:3000/openrec/
```
...
- Site URL: <https://nagacash.github.io/openrec/>
- The base URL is `/openrec/` because the org-level Pages site hosts multiple projects.
