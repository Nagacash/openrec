...
title: Quick start
sidebar_position: 3
description: "Record, trim, and export your first video with OpenRec in six steps — from opening the recording HUD to exporting a finished MP4."
keywords:
...
This walks through recording, trimming, and exporting your first video. See [Installation](./installation.md) first if you haven't installed OpenRec yet.

## 1. Open the recording HUD

Launching OpenRec shows a small floating pill (the HUD) docked at the bottom of your screen. It stays on top of everything and doesn't intercept clicks until you interact with it.
